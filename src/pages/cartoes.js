...
export default function Cartoes() {
  ...
  const adicionarOuEditarCartao = () => {
    if (!dadosFormulario.nome || !dadosFormulario.numero || !dadosFormulario.validade) return;
    ...
    setDadosFormulario({ nome: "", numero: "", validade: "", cor: "from-indigo-500 to-blue-700" });
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-300 to-rose-800 text-white p-4 rounded-3xl">
      <div className="max-w-screen-md mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-4xl font-bold text-center text-white p-4 drop-shadow-lg">Meus Cartões</h1>
          <button
            onClick={() => {
        ...
        {mostrarFormulario && (
          <div className="mb-10 bg-white/10 backdrop-blur-md p-6 rounded-xl shadow-2xl border border-white/20">
            ...
            <input
              ...
              onChange={(e) => setDadosFormulario({ ...dadosFormulario, validade: e.target.value })}
        ...
        <div className="flex flex-col items-center gap-6">
          {cartoes.map((cartao) => (
            ...
            >
              ...
              <p className="text-sm mt-2 opacity-80">Validade: {cartao.validade}</p>
